...
public final class StdDraw_new implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static StdDraw_new std = new StdDraw_new();
    ...
    public static JPanel setCanvasSize(int canvasWidth, int canvasHeight) {
    ...
    private static JPanel init() {
        ...
        frame.setTitle(" RGBY Cell Life");
        frame.setJMenuBar(createMenuBar());

        //todo:
        JPanel status = createStatus(0);
    ...
    public static void setCanvasSize1(int canvasWidth, int canvasHeight) {
        if (canvasWidth <= 0) throw new IllegalArgumentException("width must be positive");
        if (canvasHeight <= 0) throw new IllegalArgumentException("height must be positive");
        width = canvasWidth;
        height = canvasHeight;
    ...
    // todo:create the menu bar (changed to private)
    ...
    public static JPanel createStatus(final double abc) {
...
//        frame.add(time);
     ...
     * {@code StdDraw_new.BLACK}, {@code StdDraw_new.BLUE}, {@code StdDraw_new.CYAN},
     * {@code StdDraw_new.DARK_GRAY}, {@code StdDraw_new.GRAY}, {@code StdDraw_new.GREEN},
     * {@code StdDraw_new.LIGHT_GRAY}, {@code StdDraw_new.MAGENTA}, {@code StdDraw_new.ORANGE},
     * {@code StdDraw_new.PINK}, {@code StdDraw_new.RED}, {@code StdDraw_new.WHITE}, and
     * {@code StdDraw_new.YELLOW}.
     *
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to StdDraw_new)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
            URL url = StdDraw_new.class.getResource(filename);
            if (url != null)
                icon = new ImageIcon(url);
        }
...
*/
    ...
    public void actionPerformed(ActionEvent e) {
        FileDialog chooser = new FileDialog(StdDraw_new.frame, "Use a .png or .jpg extension", FileDialog.SAVE);
        chooser.setVisible(true);
        String filename = chooser.getFile();
        if (filename != null) {
            StdDraw_new.save(chooser.getDirectory() + File.separator + chooser.getFile());
        }
    }
    ...
    public void mousePressed(MouseEvent e) {
        synchronized (mouseLock) {
            mouseX = StdDraw_new.userX(e.getX());
            mouseY = StdDraw_new.userY(e.getY());
            isMousePressed = true;
        }
    }
...
//        StdDraw_new.square(0.2, 0.8, 0.1);
//        StdDraw_new.filledSquare(0.8, 0.8, 0.2);
//        StdDraw_new.circle(0.8, 0.2, 0.2);
//
//        StdDraw_new.setPenColor(StdDraw_new.BOOK_RED);
//        StdDraw_new.setPenRadius(0.02);
//        StdDraw_new.arc(0.8, 0.2, 0.1, 200, 45);
//
//        // draw a blue diamond
//        StdDraw_new.setPenRadius();
//        StdDraw_new.setPenColor(StdDraw_new.BOOK_BLUE);
//        double[] x = { 0.1, 0.2, 0.3, 0.2 };
//        double[] y = { 0.2, 0.3, 0.2, 0.1 };
//        StdDraw_new.filledPolygon(x, y);
//
//        // text
//        StdDraw_new.setPenColor(StdDraw_new.BLACK);
//        StdDraw_new.text(0.2, 0.5, "black text");
//        StdDraw_new.setPenColor(StdDraw_new.WHITE);
//        StdDraw_new.text(0.8, 0.8, "white text");
//    }
//
}
